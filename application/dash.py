...
TOTSEGSEX = tabla1_f.iloc[0]['GRAND TOTAL']
TASASEGSEX = tabla1_f.iloc[0]['tasa_acumulada']
...
delitos = pd.read_csv("https://raw.githubusercontent.com/fdealbam/Otros-delitos-que-atentan-contra-la-libertad-y-la-seguridad-sexual/main/ODcontralalibertadysegsexual2015_2021.csv")
...
# Cintillo 000
   ...
   dbc.Row([
    ...
    html.Br(),
        ...
        dbc.Row(
           [
               dbc.Col(html.P("Otros delitos que atentan contra la libertad y la seguridad sexual"),
    ...
    dbc.Row(
       ...
       dbc.Row(
            [
                ...
                html.P(
                    "En otros delitos que atentan contra la libertad y la seguridad sexual son  "
                  ...
                  " Entre 2015 y 2021 se registraron "+ str(f"{int(TOTSEGSEX):,}") +" casos, lo que representa una tasa de "+
       str(TASASEGSEX) +" delitos por cada 100 mil habitantes. "+
                  "Este dashboard analítico se compone "
    ...
    html.Br(),
     ...
     html.Br(),
       html.Br(),
        dbc.Row(
           [
               dbc.Col(html.P("Evolución de la incidencia de delitos que atentan contra la libertad y la seguridad sexual" ),
     ...
     dbc.Row(
           [
               dbc.Col(dbc.Button(([html.H5("2015", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/Otros-delitos-que-atentan-contra-la-libertad-y-la-seguridad-sexual/blob/main/application/static/Mapa%20otrosls%20Total2015.png?raw=true",
               ...
               dbc.Col(dbc.Button(([html.H5("2016", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/Otros-delitos-que-atentan-contra-la-libertad-y-la-seguridad-sexual/blob/main/application/static/Mapa%20otrosls%20Total2016.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
               ...
               dbc.Col(dbc.Button(([html.H5("2017", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/Otros-delitos-que-atentan-contra-la-libertad-y-la-seguridad-sexual/blob/main/application/static/Mapa%20otrosls%20Total2017.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
               ...
               dbc.Col(dbc.Button(([html.H5("2018", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/Otros-delitos-que-atentan-contra-la-libertad-y-la-seguridad-sexual/blob/main/application/static/Mapa%20otrosls%20Total2018.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
               ...
               dbc.Col(dbc.Button(([html.H5("2019", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/Otros-delitos-que-atentan-contra-la-libertad-y-la-seguridad-sexual/blob/main/application/static/Mapa%20otrosls%20Total2019.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
               ...
               dbc.Col(dbc.Button(([html.H5("2020", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/Otros-delitos-que-atentan-contra-la-libertad-y-la-seguridad-sexual/blob/main/application/static/Mapa%20otrosls%20Total2020.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
               ...
               dbc.Col(dbc.Button(([html.H5("2021", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/Otros-delitos-que-atentan-contra-la-libertad-y-la-seguridad-sexual/blob/main/application/static/Mapa%20otrosls%20Total2021.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
     ...
     dbc.Row(
           [
               dbc.Col(dbc.Button(([html.P("Veracruz de Ignacio de la llave", style={"font-size": 30,"color": "black","background-color": "white"}),
                  ...
                  style={'size': 2,}),
                          html.P(
                          "Los diez municipios con más delitos que atentan contra la libertad y la seguridad sexual fueron: Veracruz (698), Xalapa (600), Coatzacoalcos (308), Córdoba (247), San Andrés Tuxtla (176), Tantoyuca (156), Boca del Río (155), Tuxpan (151), Poza Rica de Hidalgo (149), y Orizaba (133).",
               ...
               dbc.Col(dbc.Button(([html.P("Puebla", style={"font-size": 30,"color": "black","background-color": "white"}),
                       dbc.CardImg(src="https://github.com/fdealbam/Otros-delitos-que-atentan-contra-la-libertad-y-la-seguridad-sexual/blob/main/application/static/pue.jpeg?raw=true",
                                    style={'size': 2,}),
                       html.P(
                           "Los diez municipios con más delitos que atentan contra la libertad y la seguridad sexual fueron: Puebla (1,835), Tehuacán (183), San Andrés Cholula (109), San Martín Texmelucan (80), San Pedro Cholula (78), Atlixco (72), Teziutlán (65), Amozoc (62), Cuautlancingo (61), y Izúcar de Matamoros (60).",
                              style={'font-size': 14, "font-family":"Arial", "text-align":"justify" }),
                       ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
                        # 'margin-left': '10px',
          ...
          dbc.Col(dbc.Button(([html.P("Tabasco", style={"font-size": 30,"color": "black","background-color": "white"}),
               ...
               dbc.Col(dbc.Button(([html.P("Nuevo León", style={"font-size": 30,"color": "black","background-color": "white"}),
                       dbc.CardImg(src="https://github.com/fdealbam/Otros-delitos-que-atentan-contra-la-libertad-y-la-seguridad-sexual/blob/main/application/static/nvoleon.jpeg?raw=true"),
                        ...
                        html.P(
                          "Los diez municipios con más delitos que atentan contra la libertad y la seguridad sexual fueron: Monterrey (761), Guadalupe (392), Apodaca (327), San Nicolás de los Garza (250), Juárez (232), García (191), Santa Catarina (145), Cadereyta Jiménez (77), San Pedro Garza García (66), y Pesquería (54).",
                           style={'font-size': 14, "font-family":"Arial", "text-align":"justify" }),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
                        # 'margin-left': '10px',
