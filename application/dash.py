...
delitos = pd.read_csv("https://raw.githubusercontent.com/fdealbam/Otros-delitos-que-atentan-contra-la-libertad-y-la-seguridad-sexual/main/ODcontralalibertadysegsexual20152021.csv")
...
mytitle=' '
tabtitle='contra la libertad y seguridad sexual'
    ...
    dbc.Row(
       ...
       dbc.Row(
            [
                ...
                html.P(
                    "Los delitos contra la libertad y seguridad sexual es uno de los delitos más graves de la violencia de género que se vive en el país, "
       ...
       str(TASATRATAPERSONAS) +" delitos por cada 100 mil habitantes. "+
                    ...
                    "Este tablero analítico se compone de una sección en la cual tratamos la contra la libertad y seguridad sexual, observamos "
    ...
    html.Br(),
     ...
     html.Br(),
       html.Br(),
        dbc.Row(
           [
               dbc.Col(html.P("Evolución de la incidencia de delitos contra la libertad y seguridad sexual" ),
     ...
     dbc.Row(
           [
               ...
               dbc.Col(dbc.Button(([html.H5("2022", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/Otros-delitos-que-atentan-contra-la-libertad-y-la-seguridad-sexual/blob/main/application/static/Mapa%20otrosls%20Total2022.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
