    ...
    dbc.Row(
       ...
       dbc.Row(
            [
                ...
                html.P(
                    "La contra la libertad y seguridad sexual es uno de los delitos más graves de la violencia de género que se vive en el país, "
    ...
    html.Br(),
     ...
     html.Br(),
       html.Br(),
        dbc.Row(
           [
               dbc.Col(html.P("Evolución de la incidencia de contra la libertad y seguridad sexual" ),
